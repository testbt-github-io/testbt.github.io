...
<div class="minibox minibox-left"><a href="{{ site.url }}/guide/vengeance/conduits-shadowlands.html">Назад:<br>Проводники (Кондуиты)</a></div>
<div class="minibox"><a href="{{ site.url }}/guide/vengeance/necrolord.html">Далее:<br>Некролорды</a></div>
