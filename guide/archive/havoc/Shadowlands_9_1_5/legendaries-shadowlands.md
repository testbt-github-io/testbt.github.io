...
<a href="{{ site.url }}/guide/archive/havoc/Shadowlands_9_1_5/legendaries-shadowlands.html"><img src="https://wow.zamimg.com/images/wow/icons/medium/runesmith_icon.jpg"><span style="color: white;"> Легендарные предметы</span></a>
...
* Слот для крафта: **Плащ**. Дает меньше характеристик чем грудь, но она занята Осколком Господства.
...
* Слот для крафта: **Пояс, Шея**. Разница между этими слотами незначительна, поэтому можете крафтить в тот слот который у вас хуже либо в шею чтоб получить больше статов.
...
* Слот для крафта: **Плащ**. Единственный не занятый Осколком Господства слот.
* Рецепт выдается на 48 уровне известности ковенаната.

**Оценка:** Новая интересная легендарная сила, имеет потенциал для игрового процесса, ориентированного на M+, 
...
* Слот для крафта: **Ноги**. Единственный не занятый Осколком Господства слот.
* Рецепт выдается на 48 уровне известности ковенаната.
...
**Оценка:** Легендарный предмет очень сильно усиливает Клеймо Вентиров. Мощная синергия в с нашими способностями делает интересным этот новый легендарный предмет для Вентиров.
...
* Слот для крафта: **Пояс**. Перчатки заняты Осколком Господства, пояс единственный доступный вариант.
...
* Слот для крафта: **Шея**. Единственный не занятый Осколком Господства слот.
 ...
 * <span class="q5">{{ site.data.legendary.Darkglare_Boon }}</span> - Также сильный легендарный предмет, простая реализация урона, игра в билде через Демонизм приветлива к новичкам, отличный постоянный урон без 
...
<div class="minibox minibox-left"><a href="{{ site.url }}/guide/archive/havoc/Shadowlands_9_1_5/talent-builds.html">Назад:<br>Таланты и Билды</a></div> 
<div class="minibox"><a href="{{ site.url }}/guide/archive/havoc/Shadowlands_9_1_5/domination-set-bonuses.html">Далее:<br>Осколки господства</a></div>
<br>